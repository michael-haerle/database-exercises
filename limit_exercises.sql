...
SELECT * FROM employees WHERE hire_date LIKE '199%' AND birth_date LIKE '%-12-25' ORDER BY hire_date ASC LIMIT 5;
...
SELECT * FROM employees WHERE hire_date LIKE '199%' AND birth_date LIKE '%-12-25' ORDER BY hire_date ASC LIMIT 5 OFFSET 50;
-- The relationship between LIMIT, OFFSET , and the page number is a complementary one.
-- LIMIT will choose how much data you see at one time.
-- OFFSET will choose where the LIMIT begins.
-- The page number tells you how far you are into the data set.
